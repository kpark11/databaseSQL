...
#         if col in messy_hr_df.columns:
#             messy_hr_df[col] = pd.to_datetime(messy_hr_df[col], errors='coerce')
#         if col in cleaned_hr_df.columns:
#             cleaned_hr_df[col] = pd.to_datetime(cleaned_hr_df[col], errors='coerce')
    
#     # Check for missing values
#     messy_hr_df.isnull().sum(), cleaned_hr_df.isnull().sum()
# except Exception as e:
#     print(e)
